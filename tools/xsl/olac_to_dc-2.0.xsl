...
<!--OLAC-to-DC crosswalk, by Gary Simons
    Modified: 21 November 2002 by Steven Bird
...
<!--<xsl:template match="/" priority="-1">
  ...
  <xsl:template name="oai_dc">
    <xsl:element name="dc" namespace="http://www.openarchives.org/OAI/2.0/oai_dc/">
      <xsl:attribute name="schemaLocation" namespace="http://www.w3.org/2001/XMLSchema-instance">http://www.openarchives.org/OAI/2.0/oai_dc/ http://www.openarchives.org/OAI/2.0/oai_dc.xml</xsl:attribute>
      <xsl:for-each select="*">
        <xsl:choose>
