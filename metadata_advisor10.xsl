...
<!--
    http://www.language-archives.org/tools/metadata/metadata_advisor10.xsl
     A stylesheet for transforming an OLAC metadata record (version 1.0)
       ...
       Gary Simons, SIL International (last updated 3 Apr 2008)
...
<xsl:stylesheet version="1.0" xmlns:dc="http://purl.org/dc/elements/1.1/"
   xmlns:dcterms="http://purl.org/dc/terms/" xmlns:olac="http://www.language-archives.org/OLAC/1.0/"
   ...
   <xsl:template match="olac:olac" mode="advise">
      ...
      <xsl:variable name="subjLang">
          <xsl:choose>
              <xsl:when
                  ...
                  >0</xsl:when>
            <xsl:when
               test="dc:subject[@xsi:type='olac:language' and @olac:code!=''] |
      ...
      <table cellpadding="2" cellspacing="6">
         ...
         <xsl:call-template name="component10">
