...
Your request has been accepted and posted on the following OLAC web page.
  ...
  http://www.language-archives.org/services.php4
...
<td bgcolor="white"><a href="service_review.php4?id=$row[id]">review</a></td>
</tr>
END;
  }
...
<td><a href="service_review.php4?id=$row[id]&op=edit">edit</a></td>
</tr>
END;
  }
  echo "</table>\n";
...
function draw_detail($id)
{
  ...
  print <<<END
<FORM ACTION="service_review.php4" METHOD="post">
<TABLE CELLPADDING="5">
END;
...
<a href="service_review.php4">Go back to summary page</a>
END;
}
