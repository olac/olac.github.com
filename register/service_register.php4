...
function draw_form()
{
  ...
  print <<<END
<FORM ACTION="service_register.php4" METHOD="post">
<TABLE CELLPADDING="5">
END;
  ...
  if ($flag)    // found some errors in entry
    ...
    if ($result[0] == "okay") {
      ...
      mail($OLAC_ADMIN_EMAIL,
           ...
           "http://www.language-archives.org/register/service_review.php4?id=$result[1].\n\n".
           "To review all requests use the following URL:\n\n".
           "http://www.language-archives.org/register/service_review.php4.\n\n".
           "Thanks,\n".
           "service_register.php4\n",
